<%-- 
    ...
    Created on : Apr 27, 2020, 1:03:11 AM
...
<html>
    ...
    <body>
        <div style="position: absolute; left: 25%; top: 2%; width: 50%; height: 109%; background-color: #cccccc">
            <div style="position: absolute; left: 5%; top: 1%; width: 90%; height: 98%">
                <h5><b>Data we process when you use Cheque Management System</b></h5>
                <br>
                <ul>
                    <li>When you set up a CMS Account, we store information you give us like your name and email address.</li>
                ...
                <h5><b>Why we process it</b></h5>
                <p>We process this data for the purposes described in our policy, including to:</p><br>
                <ul>
